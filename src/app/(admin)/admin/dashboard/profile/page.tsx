      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="glass-dark p-8 rounded-2xl border border-white/5 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input {...register("name")} className={`glass border-white/10 rounded-md ${errors.name ? "border-red-500/50" : ""}`} placeholder="John Doe" />
            ...
            <div className="space-y-2">
              ...
              <Input {...register("title")} className={`glass border-white/10 rounded-md ${errors.title ? "border-red-500/50" : ""}`} placeholder="Full-Stack Developer" />
          ...
          <div className="space-y-2">
            ...
            <Textarea {...register("about")} className={`glass border-white/10 min-h-[150px] rounded-md p-4 resize-none ${errors.about ? "border-red-500/50" : ""}`} placeholder="Tell the world about yourself..." />
        ...
        <div className="glass-dark p-8 rounded-2xl border border-white/5 space-y-6">
          <div className="flex items-center justify-between border-b border-white/5 pb-4">
            ...
            <Button type="button" variant="outline" size="sm" onClick={addEducation} className="glass border-white/10 gap-2 rounded-md uppercase tracking-widest text-[10px]">
            ...
            {education.map((item: any, index: number) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 relative group">
                <div className="space-y-2">
                  ...
                  <Input {...register(`education.${index}.institution`)} className="glass border-white/10 rounded-md" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Degree</Label>
                  <Input {...register(`education.${index}.degree`)} className="glass border-white/10 rounded-md" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Year Range</Label>
                  <Input {...register(`education.${index}.year`)} className="glass border-white/10 rounded-md" placeholder="2018 - 2022" />
                </div>
                <button 
                  type="button" 
                  onClick={() => removeEducation(index)}
                  className="absolute -top-2 -right-2 w-8 h-8 rounded-md bg-red-500 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                >
        ...
        <div className="glass-dark p-8 rounded-2xl border border-white/5 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`glass border-white/10 rounded-md ${errors.skills ? "border-red-500/50" : ""}`}
              value={skills.join(", ")}
        ...
        <div className="glass-dark p-8 rounded-2xl border border-white/5 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input {...register("socialLinks.github")} className={`glass border-white/10 rounded-md ${errors.socialLinks?.github ? "border-red-500/50" : ""}`} />
            ...
            <div className="space-y-2">
              ...
              <Input {...register("socialLinks.linkedin")} className={`glass border-white/10 rounded-md ${errors.socialLinks?.linkedin ? "border-red-500/50" : ""}`} />
            ...
            <div className="space-y-2">
              ...
              <Input {...register("socialLinks.twitter")} className={`glass border-white/10 rounded-md ${errors.socialLinks?.twitter ? "border-red-500/50" : ""}`} />
            ...
            <div className="space-y-2">
              ...
              <Input {...register("socialLinks.email")} className={`glass border-white/10 rounded-md ${errors.socialLinks?.email ? "border-red-500/50" : ""}`} />
        ...
        <div className="flex justify-end">
          <Button type="submit" disabled={loading} className="h-14 px-12 bg-primary hover:bg-primary/90 text-white font-bold text-lg rounded-md orange-glow gap-2 uppercase tracking-widest">
